...
KEYCLOAK_SERVER_URL = os.getenv("KEYCLOAK_SERVER_URL", "http://localhost:8083")
...
DD_SERVICE = os.getenv("DD_SERVICE", "contract-processing-flask")
...
MAX_DOCUMENTS, MAX_DOCUMENT_BYTES = 1_000, 15 * 1024 * 1024
